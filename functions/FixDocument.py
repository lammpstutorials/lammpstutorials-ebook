        ...
        for line in initial_tex_file:
            if ':ref:' in line:
                ...
                if len(split) == 2:
                    ...
                    elif label == "mda-label":
                        new_line = split[0] + '\hyperref[' + label + ']{MDAnalysis tutorial}' + rest[1]  
                    else:
                        print("WARNING, unfound label:", label)
                ...
                if n in self.figure_positions:
                    ...
                    for m in legend_lines:
                        ...
                        if len(legend_lines) == 1:
                            ...
                            new_tex_file_name.append("\caption{Figure: " + new_line[8:] + "} \n")
